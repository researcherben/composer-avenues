> The changes to this README are at steps 7-8+.
...
Exit the container and go back to the main directory.
...
Access "http://localhost:8080" in a browser and go through the installation steps. At the "Connect to database" step, enter the following credentials.
...
Create LocalSettings.php, download, and move it to the main directory.
